...
class NEW(SequentialRecommender):
    ...
    def augment(self, item_seq, item_seq_len, seq_output):
    ...
    def forward(self, item_seq, item_seq_len, global_seq):
    ...
    def calculate_loss(self, interaction):
        ...
        item_seq1, item_seq2, item_seq_len, split_idx = self.augment(item_seq, item_seq_len, seq_output)
